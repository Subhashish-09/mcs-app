...
const InstructorTopicDataTable = ({
  ...
  const [users, setUsers] = React.useState(topicData);
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (hasSearchFilter) {
      filteredUsers = filteredUsers.filter((user) =>
        user.topic_name.toLowerCase().includes(filterValue.toLowerCase())
      );
    }
    if (
      statusFilter !== "all" &&
          ...
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown>
              ...
              <DropdownMenu>
                <DropdownItem
                  as={Link}
                  href={"/" + startsWith + "/topic/edit/" + user.topic_id}
                >
                  Edit
                </DropdownItem>
                <DropdownItem
                  onClick={() => setDeletionTopic(user)}
                  onPress={onOpen}
                >
                  Delete
                </DropdownItem>
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Button
              color="primary"
              as={Link}
              href={"/" + startsWith + "/category/create"}
              endContent={<PlusIcon />}
            >
              Add New
            </Button>
