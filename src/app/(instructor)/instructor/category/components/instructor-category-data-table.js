...
const InstructorCategoryDataTable = ({
  categoryData,
  onOpen,
  setDeletionCategory,
}) => {
  ...
  const [users, setUsers] = React.useState(categoryData);
          ...
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown>
              ...
              <DropdownMenu>
                <DropdownItem
                  as={Link}
                  href={"/instructor/category/edit?catid=" + user.category_id}
                >
                  Edit
                </DropdownItem>
                <DropdownItem
                  onClick={() => setDeletionCategory(user)}
                  onPress={onOpen}
                >
                  Delete
                </DropdownItem>
...
export default InstructorCategoryDataTable;
