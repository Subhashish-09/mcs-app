...
const AdminTopicEdit = ({ topicData, selectedKey }) => {
  const [isSaving, setIsSaving] = useState(false);
  const [date, setDate] = useState();
  const formik = useFormik({
    initialValues: {
      category: "",
      topic_info: topicData["topic_info"],
      topic_name: topicData["topic_name"],
      topic_seo_title: topicData["topic_seo_title"],
      topic_seo_description: topicData["topic_seo_description"],
      topic_seo_keywords: topicData["topic_seo_keywords"],
      topic_seo_slug: topicData["topic_seo_slug"],
      topic_status: topicData["topic_status"],
      topic_is_active: topicData["topic_is_active"],
    },
    onSubmit: (values) => {
