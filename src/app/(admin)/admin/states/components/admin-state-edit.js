...
const AdminStateEdit = ({ selectedKey, stateData }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      state_seo_title: stateData["state_seo_title"],
      state_seo_description: stateData["state_seo_description"],
      state_seo_keywords: stateData["state_seo_keywords"],
      state_seo_slug: stateData["state_seo_slug"],
      state_status: stateData["state_status"],
      state_is_active: stateData["state_is_active"],
    },
    onSubmit: (values) => {
