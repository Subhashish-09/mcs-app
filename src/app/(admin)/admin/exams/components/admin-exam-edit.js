...
const AdminExamEdit = ({ selectedKey, examData }) => {
  ...
  const formik = useFormik({
    initialValues: {
      category: "",
      exam_info: examData["exam_info"],
      exam_name: examData["exam_name"],
      exam_seo_title: examData["exam_seo_title"],
      exam_seo_description: examData["exam_seo_description"],
      exam_seo_keywords: examData["exam_seo_keywords"],
      exam_seo_slug: examData["exam_seo_slug"],
