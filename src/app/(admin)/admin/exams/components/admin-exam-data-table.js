...
const AdminExamDataTable = ({ examData, onOpen, setDeletionExam }) => {
  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (hasSearchFilter) {
      filteredExams = filteredExams.filter((exam) =>
        exam.exam_name.toLowerCase().includes(filterValue.toLowerCase())
      );
    }
    if (
      statusFilter !== "all" &&
  ...
  }, [exams, filterValue, statusFilter]);
  ...
  const renderCell = React.useCallback((exam, columnKey) => {
          ...
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown>
              ...
              <DropdownMenu>
                <DropdownItem
                  as={Link}
                  href={"/admin/exams/view?type=edit&id=" + exam.exam_id}
                >
                  Edit
                </DropdownItem>
                <DropdownItem
                  onClick={() => setDeletionExam(exam)}
                  onPress={onOpen}
                >
                  Delete
                </DropdownItem>
        ...
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Button
              color="primary"
              as={Link}
              href={"/admin/exams/view?type=create"}
              endContent={<PlusIcon />}
            >
              Add New
            </Button>
...
export default AdminExamDataTable;
